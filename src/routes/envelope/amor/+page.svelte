<script lang="ts">
    ...
    let formData = {
        ...
        musicUrl: "https://www.youtube.com/watch?v=VWRkQARH-9o",
    };
                        ...
                        {#if formData.hasMusic}
                            ...
                            >
                                <div class="player-left">
                                    <div class="album-art">
                                        <img
                                            src="https://i.ytimg.com/vi/VWRkQARH-9o/hq720.jpg?sqp=-oaymwEnCNAFEJQDSFryq4qpAxkIARUAAIhCGAHYAQHiAQoIGBACGAY4AUAB&rs=AOn4CLBcHXMho-C067n1Y2-3N1LBOLEzoA"
                                            alt="Capa"
                                        />
